...
class AlarmStorage(context: Context) {
    ...
    data class SerializableAlarm(
        ...
        val allowSimultaneousPlayback: Boolean // New property
    )
        ...
        try {
            val serializableAlarms = alarms.map { alarm ->
                SerializableAlarm(
                    ...
                    allowSimultaneousPlayback = alarm.allowSimultaneousPlayback // New parameter
                )
            }
            ...
            serializableAlarms.mapNotNull { serializable ->
                try {
                    ...
                    AlarmItem(
                        ...
                        allowSimultaneousPlayback = serializable.allowSimultaneousPlayback // New parameter
                    )
                } catch (e: Exception) {
